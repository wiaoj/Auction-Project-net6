...
namespace ESourcing.Products.Respositories;
...
public class ProductRepository : IProductRepository
{
    ...
    {
        var updateResult = await _context.Products.ReplaceOneAsync(filter: p => p.Id.Equals(product.Id), replacement: product);
